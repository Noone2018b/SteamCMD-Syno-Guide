...
# See lines 266 - 297
STEAM_ROOT="/downloads"
MANIFEST_DIRECTORY="${STEAM_ROOT}/Steam/steamapps"
...
download_game_files()
{
  ...
  # SYNO MOD - removed options here, and set defaults at top of script instead.
	# Download
	...
	#
	# 	else
	# 		# For Syno mod, this is now set at top of script.
	# 		# STEAM_ROOT="${HOME}"
	# 		# MANIFEST_DIRECTORY="${STEAM_ROOT}/.local/share/Steam/steamapps"
	# 		# FINAL_DIRECTORY="${STEAM_ROOT}/.local/share/Steam/steamapps/common/${INSTALL_DIR}"
